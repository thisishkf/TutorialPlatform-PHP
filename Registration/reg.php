...
elseif (empty($_POST['user_id_card'])) //*
{
	$message = 'Please enter Identity card number';
}
else
{
...
else 
{
 ...
 /*** if we are here the data is valid and we can insert it into database ***/
 	$user_id_card = filter_var($_POST['user_id_card'], FILTER_SANITIZE_STRING); //*
    ...
    try
    {
        ...
        /*** prepare the insert ***/
        $stmt = $dbh->prepare("INSERT INTO techer_users (user_name, user_password, user_type , user_gender , user_email , user_phone ,user_educationBackground,user_id_card,major) VALUES (:user_name, :user_password, :user_type, :user_gender ,:user_email ,:user_phone ,:user_educationBackground,:user_id_card,:major )");
					...
					<section id="main">
						<header>
							...
							<form action="#" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" name="user_id_card" id="user_id_card"> <!-- -->
								</br>
